...
- ML libraries and frameworks: Pandas, NumPy, scikit-learn, Pytorch, TorchAudio, Librosa, Tensorflow, Keras, seaborn, Matplotlib, Hugging Face, LangChain, LlamaIndex, Streamlit, Google Colab, Jupyter Notebook, Weights and Biases (wandb) for MLOps, Anaconda, NLTK, SpaCy, Assembly AI, SingleStore DB
- Other: Linux, bash scripting, Docker, Kubernetes, CI/CD, Jira, Google Cloud Platform, Google Compute Engine, Vertex AI, AWS, S3, AWS Comprehend, AWS SageMaker, AWS SageMaker Ground Truth, API, Data formats (XML, JSON, parquet), ETL, ROS
