...
- Other: Linux, bash scripting, Docker, Jira, SQL, Google Cloud Platform, Google BigQuery, Google Compute Engine, AWS, S3, AWS Comprehend, AWS SageMaker, Amazon Mechanical Turk, AWS SageMaker Ground Truth, API, Data formats (XML, JSON, parquet), ETL
